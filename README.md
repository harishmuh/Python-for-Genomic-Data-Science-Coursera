# Python for Genomic Data-Science 2025 - Coursera
This is the third course in the Genomic Big Data Science Specialization from Johns Hopkins University (Bloomberg School of Public Health). The course is taught by Mihaela pertea PhD (Assistant Professor in Center for Computational Biology) and Steven Salzberg PhD (Professor in Biomedical Engineering, Computer Science, and Biostatistics). 
